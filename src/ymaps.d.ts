...
declare namespace ymaps {
    ...
    function geocode(request: string | number[], options?: { [key: string]: any }): Promise<IGeoObjectCollection>;
    ...
    namespace geolocation {
        ...
        function get(options?: GeoLocationOption): Promise<IGeoObjectCollection>;
    }
    ...
    namespace util {
        namespace bounds{
            function getCenterAndZoom(bounds: number[], containerSize: number[]): {center:number[], zoom: number};
        }
        namespace cursor {
            class Accessor {
